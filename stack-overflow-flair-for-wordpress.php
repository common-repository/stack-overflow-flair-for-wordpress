...
class SOFlair4WP_Widget extends WP_Widget
{
	...
	function widget($args, $instance)
	{
		...
		echo $before_widget;
		include(WP_PLUGIN_DIR . '/stack-overflow-flair-for-wordpress/view/widget.php');
   		echo $after_widget;
	}
	...
	function form($instance)
	{
		...
		include(WP_PLUGIN_DIR . '/stack-overflow-flair-for-wordpress/view/form.php');
	}
}
...
{
	include(WP_PLUGIN_DIR . '/stack-overflow-flair-for-wordpress/view/admin.php');	
}
